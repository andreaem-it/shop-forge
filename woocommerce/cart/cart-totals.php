<?php
/**
 * Cart totals — Andrea Emili layout
 *
...
<div class="cart_totals shopforge-cart-totals <?php echo WC()->customer->has_calculated_shipping() ? 'calculated_shipping' : ''; ?>">
    ...
    <div class="shopforge-coupon-wrap">
    ...
    <table class="shopforge-totals-table" cellspacing="0">
        ...
        <?php if ( wc_tax_enabled() && ! WC()->cart->display_prices_including_tax() ) :
            ...
            if ( WC()->customer->is_customer_outside_base() && ! WC()->customer->has_calculated_shipping() ) {
                $estimated_text = sprintf( ' <small>(%s)</small>',
    ...
    <div class="shopforge-totals-cta">
