...
<p><?php printf( esc_html__( 'Gentile %s,', 'shopforge' ), esc_html( $user ? $user->display_name : '' ) ); ?></p>
<p><?php esc_html_e( 'Abbiamo ricevuto la tua richiesta di preventivo. Ti risponderemo il prima possibile con un\'offerta personalizzata.', 'shopforge' ); ?></p>
...
<p>
	<a href="<?php echo esc_url( wc_get_account_endpoint_url( 'shopforge-quotes' ) ); ?>"
	   style="display:inline-block;background:#96588a;color:#fff;padding:10px 20px;text-decoration:none;border-radius:4px;font-weight:bold;">
		<?php esc_html_e( 'I miei preventivi →', 'shopforge' ); ?>
	</a>
</p>
