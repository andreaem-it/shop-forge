...
<p><?php printf( esc_html__( 'Hi %s,', 'shopforge' ), esc_html( $order->get_billing_first_name() ) ); ?></p>
<p><?php printf( esc_html__( 'We received your support request for order #%s. Our team will reply as soon as possible.', 'shopforge' ), esc_html( $order->get_order_number() ) ); ?></p>
...
<table cellspacing="0" cellpadding="6" style="width:100%;border:1px solid #e0e0e0;border-collapse:collapse;margin-bottom:20px;">
	...
	<tr>
		<th style="text-align:left;border:1px solid #e0e0e0;padding:8px 12px;background:#f8f8f8;"><?php esc_html_e( 'Your message', 'shopforge' ); ?></th>
